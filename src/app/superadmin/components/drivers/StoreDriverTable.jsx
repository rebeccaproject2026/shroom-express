...
const STORE_DRIVERS_DATA = [
    { id: '#Driver-ID', name: 'Liam Carter', initials: 'L', store: 'Forest Oasis', zone: 'Brampton', vehicle: 'Honda Civic 2021', status: 'Active', orders: 142, today: 8, rating: 4.8, earnings: '$1,840' },
    { id: '#Driver-ID', name: 'Mei Lin', initials: 'M', store: 'Healthy Greens', zone: 'Ottawa', vehicle: 'Toyota Corolla 2022', status: 'Active', orders: 118, today: 6, rating: 4.9, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Omar Patel', initials: 'O', store: 'Pure Origins', zone: 'Calgary', vehicle: 'Kia Soul 2020', status: 'Inactive', orders: 96, today: 0, rating: 3.8, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Clara Russo', initials: 'C', store: 'Bloom Essentials', zone: 'Iqaluit', vehicle: 'Subaru Impreza 2019', status: 'Suspended', orders: 84, today: 5, rating: 4.7, earnings: '$1,200' },
    { id: '#Driver-ID', name: 'Omar Patel', initials: 'O', store: 'Pure Origins', zone: 'Calgary', vehicle: 'Kia Soul 2020', status: 'Inactive', orders: 96, today: 0, rating: 3.8, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Clara Russo', initials: 'C', store: 'Bloom Essentials', zone: 'Brampton', vehicle: 'Subaru Impreza 2019', status: 'Suspended', orders: 84, today: 5, rating: 4.7, earnings: '$1,840' },
    { id: '#Driver-ID', name: 'Liam Carter', initials: 'L', store: 'Forest Oasis', zone: 'Ottawa', vehicle: 'Honda Civic 2021', status: 'Active', orders: 142, today: 8, rating: 4.8, earnings: '$1,560' },
];

const StoreDriverTable = () => {
    ...
    const columns = useMemo(() => [
            ...
            cell: ({ row }) => (
                <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-[11px] underline font-medium text-[#64748B] mt-0.5">{row.original.id}</p>
                    </div>
                </div>
            )
        },
        {
            accessorKey: 'store',
            header: 'STORE',
            cell: ({ getValue }) => <span className="text-sm font-medium text-[#181211]">{getValue()}</span>
        },
        {
            accessorKey: 'zone',
            header: 'ZONE',
        ...
        },
        {
            ...
            cell: ({ getValue }) => (
                <div className="flex items-center gap-1">
                    <Icon icon="material-symbols:star-rounded" width="16" className="text-[#F2994A]" />
                    <span className="text-sm font-semibold text-[#FF9F40]">{getValue()}</span>
                </div>
            )
        },
        {
            ...
            header: 'EARNINGS',
            cell: ({ getValue }) => <span className="text-sm font-semibold text-[#475569]">{getValue()}</span>
        },
        {
            id: 'actions',
            header: 'ACTIONS',
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#E2E8F0] overflow-hidden font-manrope">
            ...
            <div className="px-4.5 py-3 bg-white">
                <p className="text-[14px] text-[#64748B] font-medium leading-none">
                    Showing <span className="font-bold text-[#181211]">7</span> of <span className="font-bold text-[#181211]">15 store drivers</span>
                </p>
            </div>
...
export default StoreDriverTable;
