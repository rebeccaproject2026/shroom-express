...
const IN_HOUSE_DRIVERS_DATA = [
    { id: '#Driver-ID', name: 'Jordan Lee', initials: 'JL', zone: 'Brampton', vehicle: 'Honda Civic 2021', status: 'Active', orders: 201, today: 11, rating: 4.8, earnings: '$1,840' },
    { id: '#Driver-ID', name: 'Nadia Volkov', initials: 'NV', zone: 'Ottawa', vehicle: 'Toyota Corolla 2022', status: 'Active', orders: 178, today: 9, rating: 4.9, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Raj Mehta', initials: 'RM', zone: 'Calgary', vehicle: 'Kia Soul 2020', status: 'Inactive', orders: 134, today: 0, rating: 3.8, earnings: '$1,840' },
    { id: '#Driver-ID', name: 'Nadia Volkov', initials: 'NV', zone: 'Ottawa', vehicle: 'Toyota Corolla 2022', status: 'Active', orders: 178, today: 9, rating: 4.9, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Raj Mehta', initials: 'RM', zone: 'Calgary', vehicle: 'Kia Soul 2020', status: 'Inactive', orders: 134, today: 0, rating: 3.8, earnings: '$1,110' },
    { id: '#Driver-ID', name: 'Nadia Volkov', initials: 'NV', zone: 'Ottawa', vehicle: 'Toyota Corolla 2022', status: 'Active', orders: 178, today: 9, rating: 4.9, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Jordan Lee', initials: 'JL', zone: 'Brampton', vehicle: 'Honda Civic 2021', status: 'Active', orders: 201, today: 11, rating: 4.8, earnings: '$1,840' },
    { id: '#Driver-ID', name: 'Nadia Volkov', initials: 'NV', zone: 'Ottawa', vehicle: 'Toyota Corolla 2022', status: 'Suspended', orders: 178, today: 9, rating: 4.9, earnings: '$1,560' },
    { id: '#Driver-ID', name: 'Jordan Lee', initials: 'JL', zone: 'Brampton', vehicle: 'Honda Civic 2021', status: 'Active', orders: 201, today: 11, rating: 4.8, earnings: '$1,840' },
];

const InHouseDriverTable = () => {
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#E2E8F0] overflow-hidden font-manrope">
            ...
            <div className="px-4.5 py-3 bg-white">
                <p className="text-[14px] text-[#64748B] font-medium leading-none">
                    Showing <span className="font-bold text-[#181211]">9</span> of <span className="font-bold text-[#181211]">20 store drivers</span>
                </p>
            </div>
...
export default InHouseDriverTable;
