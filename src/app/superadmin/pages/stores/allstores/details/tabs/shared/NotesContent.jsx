    ...
    const notes = [
        {
            ...
            content: "Followed up with vendor via email about missing insurance certificate. They confirmed it will be uploaded within 48 hours.",
        ...
        },
        {
            ...
            content: "Store looks legitimate. Owner ID verified. Waiting for insurance certificate before final approval.",
