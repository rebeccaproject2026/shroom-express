...
const OperationsContent = ({ store }) => {
    if (!store) return null;
    const days = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
    const activeDays = store.operatingDays || [];
            ...
            <div className="mb-4">
                ...
                <div className="space-y-4">
                    ...
                    <div className="border border-[#E2E8F0] rounded-lg p-4">
                        <div className="flex items-center justify-between mb-4 border-b border-[#E2E8F0] pb-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-[#475569] font-medium">Orders delivered the same day they are placed</p>
                            </div>
                            <Toggle enabled={store.estimatedDelivery === "Same-day Delivery"} />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-sm px-4 py-2.5 text-[#181211] text-[14px] font-semibold flex items-center gap-2">
                                    ...
                                    <span className='text-[#475569]'>{store.minOrderAmount || '0.00'}</span>
                                </div>
                            </div>
                            <Field label="Max Delivery Radius (ml)" value={store.maxDeliveryRadius || '0'} required />
                        </div>
                    </div>
                    ...
                    <div className="border border-[#E2E8F0] rounded-lg p-4 flex items-center justify-between">
                        ...
                        <Toggle enabled={store.expressDelivery} />
                    </div>
                    ...
                    <div className="border border-[#E2E8F0] rounded-lg p-4 flex items-center justify-between">
                        ...
                        <Toggle enabled={store.shippingMailOrder} />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-4">
                <div className="space-y-2">
                    ...
                    <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-sm px-4 py-2.5 text-[#475569] text-sm font-semibold flex items-center justify-between">
                        <span>{store.openingTime || 'N/A'}</span>
                ...
                <div className="space-y-2">
                    ...
                    <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-sm px-4 py-2.5 text-[#475569] text-sm font-semibold flex items-center justify-between">
                        <span>{store.closingTime || 'N/A'}</span>
                        <Icon icon="mingcute:time-line" className="text-[#181211]" width="18" />
                    </div>
                </div>
            </div>
            ...
            <div className="mb-4.5">
                ...
                <div className="space-y-4">
                    <div className="border border-[#E2E8F0] rounded-lg p-4 flex items-center justify-between">
                        ...
                        <Toggle enabled={store.autoAcceptOrders} />
                    </div>
                    <div className="border border-[#E2E8F0] rounded-lg p-4 flex items-center justify-between">
                        <div className="space-y-1">
                        ...
                        <Toggle enabled={store.isFeatured} />
                    </div>
                    <div className="border border-[#E2E8F0] rounded-lg p-4 flex items-center justify-between">
                        <div className="space-y-1">
                        ...
                        <Toggle enabled={store.status === "Active" || store.status === "ACTIVE"} />
                    </div>
                </div>
            </div>
        </div>
