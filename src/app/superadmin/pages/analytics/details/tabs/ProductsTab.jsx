...
const ProductStatCard = ({ label, value, description }) => (
...
const ProductsTab = () => {
    ...
    const series = [
        { name: 'Orders', data: [35, 55, 42, 58, 50, 85] },
        { name: 'Customers', data: [25, 45, 32, 48, 42, 68] }
    ];
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 font-manrope">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
                <ProductStatCard label="Avg Session" value="4.2 min" description="Per admin user" />
                <ProductStatCard label="Page Views" value="12,840" description="This month" />
                <ProductStatCard label="Actions Taken" value="3,241" description="CRUD operations" />
                <ProductStatCard label="Error Rate" value="0.08%" description="System errors" />
            </div>
