...
import InHouseDriverTable from "../../../components/drivers/InHouseDriverTable";

const InHouseDrivers = () => {
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-1">
                        <h1 className="text-lg font-bold text-[#181211]">In-house Drivers</h1>
                        <p className="text-[#475569] font-medium text-sm">Full-time ShroomExpress staff drivers — highest priority dispatch order.</p>
                    </div>
