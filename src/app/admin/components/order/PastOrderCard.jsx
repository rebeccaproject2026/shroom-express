...
const PastOrderCard = ({ order }) => {
  ...
  return (
    <div className="border border-gray-200 rounded-sm bg-white overflow-hidden shadow-sm mb-3 sm:mb-4">
      <div className="bg-[#212529] text-white px-2 sm:px-3 py-2 sm:py-2.5 rounded-t-sm">
        <span className="font-medium text-xs sm:text-sm">Order #{order.orderId}</span>
      </div>
      <div className="p-2 sm:p-3">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
          <p className="text-xs text-gray-500">Order Date: {order.orderDate}</p>
          <span className={`inline-flex px-2 sm:px-2.5 py-0.5 rounded-md text-xs font-semibold shrink-0 self-start sm:self-auto ${statusClass}`}>
            {order.status}
          </span>
        </div>
        <div className="grid grid-cols-1 xsm:grid-cols-2 lg:grid-cols-4 gap-x-3 sm:gap-x-4 gap-y-2 sm:gap-y-3 text-xs sm:text-sm mb-3 sm:mb-4">
          ...
          <div className="block xsm:col-span-2 lg:col-span-2">
        ...
        <div className="flex flex-col xsm:flex-row xsm:flex-wrap gap-2 xsm:justify-end">
          <button
            type="button"
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-medium text-white bg-[#343a40] hover:bg-[#23272b] rounded-sm transition-colors"
          >
            View Details
          </button>
          <button
            type="button"
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-medium text-gray-900 bg-[#ffc107] hover:bg-[#e0a800] rounded-sm transition-colors"
          >
            Download Invoice
          </button>
          <button
            type="button"
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-medium text-white bg-[#0066FF] hover:bg-[#0052CC] rounded-sm transition-colors"
          >
            Reorder
          </button>
        </div>
