...
const navItems = [
  { to: "/driver/dashboard", label: "Dashboard", Icon: <Icon icon="solar:widget-2-outline" width="24" height="24" className="*:stroke-[1.4px]" /> },
  { to: "/driver/orders", label: "My Deliveries", Icon: <Icon icon="hugeicons:truck-delivery" width="24" height="24" className="*:stroke-[1.4px]" /> },
  { to: "/driver/history", label: "Delivery History", Icon: <Icon icon="iconamoon:history-light" width="24" height="24" /> },
  { to: "/driver/earnings", label: "Earnings", Icon: <Icon icon="fluent:wallet-credit-card-16-regular" width="24" height="24" /> },
  { to: "/driver/documents", label: "Documents", Icon: < Icon icon="solar:documents-linear" width="24" height="24" className="*:stroke-[1.4px]" /> },
  { to: "/driver/profile", label: "Profile", Icon: <Icon icon="proicons:person-2" width="24" height="24" /> },
  { to: "/driver/support", label: "Support", Icon: <Icon icon="hugeicons:customer-support" width="24" height="24" /> },
