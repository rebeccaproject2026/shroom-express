...
const NotificationItem = ({ item, onClick }) => {
    ...
    return (
        ...
        >
            ...
            {/* Left Icon */}
            <div className={`flex-shrink-0 w-8 h-8 flex items-center justify-center mr-4 ${iconColorClass}`}>
            ...
            <div className="flex-1 min-w-0 pr-2">
                <div className="flex justify-between items-center mb-1 gap-2">
                    <h4
                        className="text-[14px] font-[600] text-[#1f2937] truncate leading-tight flex-shrink"
                        title={title}
                    >
                        {title}
                    </h4>
                    <span className="text-[11px] text-[#6b7280] font-[500] whitespace-nowrap flex-shrink-0">
                        {timeText}
                    </span>
                </div>
                <p
            ...
            {/* Right Chevron Icon */}
            <div className="flex-shrink-0 flex items-center text-[#9ca3af]">
