...
const methods = [
    ...
    { id: 'express', label: 'Express Delivery', sub: 'Delivery within 1 hour', price: '$15', priceVal: 15, icon: 'mage:electricity' },
            ...
            {methods.slice(0, 2).map(m => (
                <button
                    ...
                    className={`flex items-center justify-between px-4 py-3 rounded-xl border transition-all ${
                        selected === m.id ? 'border-[#E93E2B1A] bg-[#E93E2B0D]' : 'border-[#E2E8F0] bg-white'
                    }`}
                >
