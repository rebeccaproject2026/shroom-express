...
const CheckBadge = ({ label, isSelected, onClick }) => (
  <button
    ...
    className={`flex items-center gap-2 px-2 py-2 border rounded-sm transition-all ${isSelected
      ? 'border-[#E93E2B] bg-[#FFF0EE] text-[#E93E2B]'
      : 'border-[#BDBDD2] bg-white text-[#181211] hover:border-gray-300'
      }`}
  >
    <div className={`w-5 h-5 rounded-sm flex items-center justify-center transition-all ${isSelected ? 'bg-[#E93E2B] border-[#E93E2B]' : 'bg-white border-2 border-[#BDBDD2]'}`}>
      ...
      <div className="p-4 border-b border-[#BDBDD2] flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#FFEDEB] rounded-sm flex items-center justify-center shrink-0">
            <Icon icon="la:industry" className="text-[#E93E2B]" width="24" />
          </div>
          <div>
      ...
      <div className="p-5 space-y-7">
        ...
        <div className="space-y-4">
          <label className="text-sm font-semibold text-[#181211] block">
            Product Types Available <span className="text-[#E93E2B] ml-0.5">*</span>
          </label>
