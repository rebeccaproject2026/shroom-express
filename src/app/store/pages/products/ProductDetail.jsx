              ...
              <div className="flex gap-3">
                {product.images.map((img, idx) => (
                  <button
                    ...
                    className={`w-26 h-26 bg-white rounded-lg p-2 border-2 transition-all shadow-[0px_5px_16px_0px_#00000029] ${
                      selectedImage === idx
            ...
            <div>
              ...
              <div className="flex gap-4 mb-4">
                <button className="flex-1 bg-(--store-primary) text-white py-4 rounded-lg font-semibold text-base hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
                  <Icon icon="lucide:shopping-cart" width="22" height="22" />
                  Add to cart
                </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-1 bg-white px-4 py-6 rounded-2xl border border-[#E8E8E8] h-fit">
                <div className="flex flex-col items-center">
                  ...
                  {/* Write Review Button */}
                  <button className="w-full py-3 border-2 border-[#E85D4C] text-[#E85D4C] rounded-lg font-semibold hover:bg-[#E85D4C] hover:text-white transition-colors">
                    Write a Review
                  </button>
                </div>
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="bg-white border border-[#E8E8E8] rounded-lg p-8 mb-6 text-center">
                  {showLoginForm ? (
                    <>
                      <h3 className="text-2xl font-bold text-[#181211] mb-2 text-left">
                        Write a Review
                      </h3>

                      <div className="text-left mb-3">
                        <p className="text-sm font-semibold text-[#334155] mb-1">Your Rating</p>
                        <div className="flex items-center gap-1">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <button
                              key={star}
                      ...
                      <div className="text-left mb-3">
                        <p className="text-sm font-semibold text-[#334155] mb-1">Review Content</p>
                        <textarea
                          value={reviewText}
